...
const Socials: React.FC<IconTemplateProps> = ({ name, iconImg, link }) => {
  return (
    <a
      href={link}
      ...
      className={`flex items-center mx-auto w-2/3 xl:w-1/2 lg:mx-auto rounded-3xl bg-white   hover:bg-primary hover:text-white transition-all ease-in-out 
